...
conf=conf/Stage2_V006SStoV006S1_Enc_FT.yaml
...
resume="exp/V006_SS_max_valid_V006_S1_max_valid_2000_vtn.tts_pt.v1.ppg_sxliu_V006/checkpoint-50000steps.pkl"  # checkpoint path to resume training
