...
conf=conf/vtn.tts_pt.v1.ppg_sxliu_V001.yaml

# dataset configuration
src_db_root=./downloads/V001_SS_max_valid      # default saved here
trg_db_root=./downloads/V001_S1_max_valid  # PLEASE CHANGE THIS
dumpdir=dump                                    # directory to dump full features
srcspk=V001_SS_max_valid
trgspk=V001_S1_max_valid
