...
conf=conf/vtn.tts_pt.v1.ppg_sxliu_V006S1_to_V006SS_decoder.yaml
...
resume="/home/kevingenghaopeng/vc/seq2seq-vc/egs/l2-arctic/lsc/exp/V000_R_max_valid_V006_SS_max_valid_2000_vtn.tts_pt.v1.ppg_sxliu_V006/checkpoint-38000steps.pkl"  # checkpoint path to resume training
